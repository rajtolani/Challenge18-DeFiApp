...
# Commented the line below, effectively deleting it from code but keeping from historical perspective
#input_data = st.text_input("Block Data")

# @TODO:
# Add an input area where you can get a value for `sender` from the user.
# YOUR CODE HERE
# Store user input "Sender" in variable sender
sender = st.text_input("Sender")
# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
# YOUR CODE HERE
# Store user input "Receiver" in variable receiver
receiver = st.text_input("Receiver")
# @TODO:
# Add an input area where you can get a value for `amount` from the user.
# YOUR CODE HERE
# Store user input "Amount" in variable amount. Use st.numbar_input with step of 0.01 to allow for decimal input
...
if st.button("Add Block"):
    ...
    # @TODO
    #input create new instance of Record classs based on user inputs.
    input_record=Record(sender=sender, receiver=receiver,amount=amount)
